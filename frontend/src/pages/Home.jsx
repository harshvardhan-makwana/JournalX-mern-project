    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      <section className="text-center py-20 px-6">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          The simplest place to write down to your thoughts,memories and details of your day. Secure private, and just for you
        </p>
      ...
      <section className="py-16 px-6 grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="text-center p-6 bg-white shadow-md rounded-xl hover:shadow-xl transition">
          ...
          <p className="text-gray-600">Only you can see your diary it is a secured with a password</p>
        </div>
        <div className="text-center p-6 bg-white shadow-md rounded-xl hover:shadow-xl transition">
          <div className="text-5xl mb-3">✍️</div>
          <h3 className="text-xl font-bold mb-2 text-purple-700">Easy Writing</h3>
          <p className="text-gray-600">Add, Edit, or  Delete there are no limits</p>
        </div>
        <div className="text-center p-6 bg-white shadow-md rounded-xl hover:shadow-xl transition">
          <div className="text-5xl mb-3">☁️</div>
